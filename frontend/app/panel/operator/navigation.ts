 ...
 *
 * Four positions, because those are the four things the operator manages in
 * the system they use today (card T-15.3). The shape and the "which one am I
 * on" rule are shared with the applicant panel (../navigation.ts).
 *
