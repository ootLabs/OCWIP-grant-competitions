...
**Dane testowe są już gotowe.** `scripts/seed.py` wstawia dokładnie taki układ: wniosek złożony należy do wnioskodawcy 1, roboczy do wnioskodawcy 2. Identyfikatory są stałe (`00000000-0000-4000-a000-0000000000NN`), więc test może je cytować.
