...
namespace Ocwip.Api.Data.Migrations
{
    ...
    [Migration("20260926093257_AddReports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ocwip.Api.Models.Application", b =>
                {
                    ...
                    b.Property<decimal?>("AwardedGrant")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("awarded_grant")
                    ...
                    b.HasAlternateKey("CompetitionId", "Id")
                        .HasName("ak_applications_competition_id_id");
                    ...
                    b.ToTable("applications", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_applications_awarded_grant_positive", "awarded_grant IS NULL OR awarded_grant > 0");

                            t.HasCheckConstraint("ck_applications_deactivated_at_matches_is_active", "is_active = (deactivated_at IS NULL)");

                            t.HasCheckConstraint("ck_applications_number_matches_status", "(status <> 'Draft') = (number IS NOT NULL)");

                            t.HasCheckConstraint("ck_applications_submitted_at_matches_status", "(status <> 'Draft') = (submitted_at IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Ocwip.Api.Models.Competition", b =>
                {
                    ...
                    b.Property<decimal?>("DivergenceThresholdPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("divergence_threshold_percent");
                    ...
                    b.Property<DateTimeOffset?>("EvaluationCardsSharedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("evaluation_cards_shared_at")
                        .HasComment("When the evaluation cards were shared with the applicants (T-41b). Null until then; set once and never cleared.");

                    b.Property<int>("EvaluatorsPerApplication")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2)
                        .HasColumnName("evaluators_per_application");
                    ...
                    b.Property<Guid?>("FormalCardDefinitionId")
                        .HasColumnType("uuid")
                        .HasColumnName("formal_card_definition_id");
                    ...
                    b.Property<Guid?>("MeritCardDefinitionId")
                        .HasColumnType("uuid")
                        .HasColumnName("merit_card_definition_id");

                    b.Property<decimal?>("MeritThreshold")
                        .HasPrecision(7, 2)
                        .HasColumnType("numeric(7,2)")
                        .HasColumnName("merit_threshold");
                    ...
                    b.Property<Guid?>("ReportFormDefinitionId")
                        .HasColumnType("uuid")
                        .HasColumnName("report_form_definition_id");
                    ...
                    b.Property<string>("ResultEmailFunded")
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)")
                        .HasColumnName("result_email_funded");

                    b.Property<string>("ResultEmailRejected")
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)")
                        .HasColumnName("result_email_rejected");

                    b.Property<string>("ResultEmailReserve")
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)")
                        .HasColumnName("result_email_reserve");

                    b.Property<DateTimeOffset?>("ResultsApprovedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("results_approved_at")
                        .HasComment("When the operator approved the results (T-42). Null while the decisions are a draft; set once and never cleared.");
                    ...
                    b.Property<string>("ScoreAggregation")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasDefaultValue("Sum")
                        .HasColumnName("score_aggregation");
                    ...
                    b.Property<bool>("ThresholdIncludesStrategic")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("threshold_includes_strategic");
                    ...
                    b.HasIndex("Id", "FormalCardDefinitionId")
                        .HasDatabaseName("ix_competitions_id_formal_card_definition_id");

                    b.HasIndex("Id", "MeritCardDefinitionId")
                        .HasDatabaseName("ix_competitions_id_merit_card_definition_id");

                    b.HasIndex("Id", "ReportFormDefinitionId")
                        .HasDatabaseName("ix_competitions_id_report_form_definition_id");
                    ...
                    b.ToTable("competitions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_competitions_evaluation_settings", "evaluators_per_application > 0 AND (merit_threshold IS NULL OR merit_threshold >= 0) AND (divergence_threshold_percent IS NULL OR divergence_threshold_percent BETWEEN 0 AND 100) AND score_aggregation IN ('Sum', 'Average')");
            ...
            modelBuilder.Entity("Ocwip.Api.Models.Evaluation", b =>
                {
                    ...
                    b.HasIndex("AuthorUserId")
                        .HasDatabaseName("ix_evaluations_author_user_id");

                    b.HasIndex("EnteredByUserId")
                        .HasDatabaseName("ix_evaluations_entered_by_user_id");

                    b.HasIndex("ApplicationId", "AuthorUserId")
                        .IsUnique()
                    ...
                    b.HasIndex("CompetitionId", "ApplicationId")
                        .HasDatabaseName("ix_evaluations_competition_id_application_id");

                    b.HasIndex("CompetitionId", "FormDefinitionId")
                        .HasDatabaseName("ix_evaluations_competition_id_form_definition_id");

                    b.ToTable("evaluations", null, t =>
                        {
                            t.HasCheckConstraint("ck_evaluations_answers_is_an_object", "jsonb_typeof(answers) = 'object'");

                            t.HasCheckConstraint("ck_evaluations_deactivated_at_matches_is_active", "is_active = (deactivated_at IS NULL)");

                            t.HasCheckConstraint("ck_evaluations_finished_at_matches_status", "(status = 'Finished') = (finished_at IS NOT NULL)");

                            t.HasCheckConstraint("ck_evaluations_one_author", "(author_user_id IS NULL) <> (author_name IS NULL)");

                            t.HasCheckConstraint("ck_evaluations_stage_known", "stage IN ('Formal', 'Merit')");

                            t.HasCheckConstraint("ck_evaluations_status_known", "status IN ('Draft', 'Finished')");
                        });
                });
            ...
            modelBuilder.Entity("Ocwip.Api.Models.FormDefinition", b =>
                {
                    ...
                    b.HasIndex("CompetitionId", "Purpose", "VersionNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_form_definitions_competition_id_purpose_version_number");
                    ...
                    b.ToTable("form_definitions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_form_definitions_purpose_known", "purpose IN ('Application', 'FormalEvaluation', 'MeritEvaluation', 'Report')");
            ...
            modelBuilder.Entity("Ocwip.Api.Models.Report", b =>
                {
                    ...
                    b.HasIndex("EntityId")
                        .HasDatabaseName("ix_reports_entity_id");

                    b.HasIndex("FormDefinitionId")
                        .HasDatabaseName("ix_reports_form_definition_id");

                    b.HasIndex("CompetitionId", "Status")
                        .HasDatabaseName("ix_reports_competition_id_status");

                    b.ToTable("reports", null, t =>
                        {
                            t.HasCheckConstraint("ck_reports_accepted_at_matches_status", "(status = 'Accepted') = (accepted_at IS NOT NULL)");

                            t.HasCheckConstraint("ck_reports_answers_is_an_object", "jsonb_typeof(answers) = 'object' AND jsonb_typeof(prefill) = 'object'");

                            t.HasCheckConstraint("ck_reports_submitted_at_matches_status", "(status = 'Draft') = (submitted_at IS NULL)");
                        });
                });

            modelBuilder.Entity("Ocwip.Api.Models.ReportStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ChangedByUserId")
                        .HasDatabaseName("ix_report_status_history_changed_by_user_id");
            ...
            modelBuilder.Entity("Ocwip.Api.Models.ResultNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_result_notifications");

                    b.HasIndex("ApplicationId")
                        .IsUnique()
                        .HasDatabaseName("ix_result_notifications_application_id");

                    b.HasIndex("CompetitionId", "SentAt")
                        .HasDatabaseName("ix_result_notifications_competition_id_sent_at");

                    b.ToTable("result_notifications", null, t =>
                        {
                            t.HasCheckConstraint("ck_result_notifications_attempts_not_negative", "attempts >= 0");

                            t.HasCheckConstraint("ck_result_notifications_result", "result IN ('Funded', 'Reserve', 'Rejected')");
                        });
                });

            modelBuilder.Entity("Ocwip.Api.Models.ReviewerDeclaration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_reviewer_declarations");

                    b.HasIndex("ReviewerId")
                        .HasDatabaseName("ix_reviewer_declarations_reviewer_id");

                    b.HasIndex("CompetitionId", "ReviewerId")
                        .IsUnique()
                        .HasDatabaseName("ux_reviewer_declarations_one_active")
                        .HasFilter("is_active");

                    b.ToTable("reviewer_declarations", null, t =>
                        {
                            t.HasCheckConstraint("ck_reviewer_declarations_deactivated_at_matches_is_active", "is_active = (deactivated_at IS NULL)");

                            t.HasCheckConstraint("ck_reviewer_declarations_reason_matches_decision", "accepted = (refusal_reason IS NULL) AND (refusal_reason IS NULL OR length(btrim(refusal_reason)) > 0)");
                        });
                });
            ...
            modelBuilder.Entity("Ocwip.Api.Models.Competition", b =>
                {
                    ...
                    b.HasOne("Ocwip.Api.Models.FormDefinition", null)
                        .WithMany()
                        .HasForeignKey("Id", "FormalCardDefinitionId")
                        .HasPrincipalKey("CompetitionId", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_competitions_form_definitions_id_formal_card_definition_id");

                    b.HasOne("Ocwip.Api.Models.FormDefinition", null)
                        .WithMany()
                        .HasForeignKey("Id", "MeritCardDefinitionId")
                        .HasPrincipalKey("CompetitionId", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_competitions_form_definitions_id_merit_card_definition_id");

                    b.HasOne("Ocwip.Api.Models.FormDefinition", null)
                        .WithMany()
                        .HasForeignKey("Id", "ReportFormDefinitionId")
                        .HasPrincipalKey("CompetitionId", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_competitions_form_definitions_id_report_form_definition_id");
                });
            ...
            modelBuilder.Entity("Ocwip.Api.Models.Evaluation", b =>
                {
                    b.HasOne("Ocwip.Api.Models.User", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_evaluations_asp_net_users_author_user_id");
                    ...
                    b.HasOne("Ocwip.Api.Models.User", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_evaluations_asp_net_users_entered_by_user_id");

                    b.HasOne("Ocwip.Api.Models.Application", "Application")
                        .WithMany()
                        .HasForeignKey("CompetitionId", "ApplicationId")
                        .HasPrincipalKey("CompetitionId", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_evaluations_applications_competition_id_application_id");
                    ...
                    b.HasOne("Ocwip.Api.Models.FormDefinition", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_evaluations_form_definitions_competition_id_form_definition");
            ...
            modelBuilder.Entity("Ocwip.Api.Models.Report", b =>
                {
                    b.HasOne("Ocwip.Api.Models.Application", "Application")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_reports_applications_application_id");
                    ...
                    b.HasOne("Ocwip.Api.Models.Competition", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_reports_competitions_competition_id");
                    ...
                    b.HasOne("Ocwip.Api.Models.Entity", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_reports_entities_entity_id");
                    ...
                    b.HasOne("Ocwip.Api.Models.FormDefinition", "FormDefinition")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_reports_form_definitions_form_definition_id");
            ...
            modelBuilder.Entity("Ocwip.Api.Models.ReportStatusHistory", b =>
                {
                    b.HasOne("Ocwip.Api.Models.User", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_report_status_history_asp_net_users_changed_by_user_id");

                    b.HasOne("Ocwip.Api.Models.Report", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ocwip.Api.Models.ResultNotification", b =>
                {
                    b.HasOne("Ocwip.Api.Models.Application", null)
                        .WithMany()
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_result_notifications_applications_application_id");
                    ...
                    b.HasOne("Ocwip.Api.Models.Competition", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_result_notifications_competitions_competition_id");
                });
            ...
            modelBuilder.Entity("Ocwip.Api.Models.ReviewerDeclaration", b =>
                {
                    b.HasOne("Ocwip.Api.Models.Competition", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_reviewer_declarations_competitions_competition_id");
